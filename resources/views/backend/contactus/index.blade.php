                            ...
                            <tbody class="text-gray-600 fw-semibold">
                                @foreach ($contacts as $contact)
                                    <tr>
                                        <td></td>
                                        <td class="">
                                            <p class="text-gray-800 text-hover-primary mb-1">{{ $contact->name }}
                                            </p>
                                        </td>
                                        <td class="">
                                            <p class="text-gray-800 text-hover-primary mb-1">{{ $contact->email }}
                                            </p>
                                        </td>
                                        <td class="">
                                            <p class="text-gray-800 text-hover-primary mb-1">{{ $contact->subject }}
                                            </p>
                                        </td>
                                        <td class="">
                                            <p class="text-gray-800 text-hover-primary mb-1">{{ $contact->message }}
                                            </p>
                                        </td>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                ...
                                                {{-- <div class="menu-item px-3">
                                                    <a href="{{route('contact-us.edit',$contact->id)}}" class="menu-link px-3">Edit</a>
                                                </div> --}}
                                                <div class="menu-item px-3">
                                                    <a href="{{route('contact-us.show',$contact->id)}}" class="menu-link px-3">View</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
