        ...
        <div id="kt_app_toolbar" class="app-toolbar pt-5">
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex justify-content-between">
                <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4">
                    <div class="page-title d-flex flex-column gap-1 me-3 mb-2">
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold mb-6">
                            ...
                            <li class="breadcrumb-item text-gray-700 fw-bold lh-1">Service</li>
                            <li class="breadcrumb-item">
                                <i class="ki-duotone ki-right fs-4 text-gray-700 mx-n1"></i>
                            </li>
                ...
                <div class="action-btn">
                    <a href="{{ url('hotelservice') }}" class="btn btn-sm btn-primary p-4">
                        Back
                    </a>
                </div>
            </div>
            ...
            <div id="kt_app_content_container" class="app-container container-fluid">
                <div class="card">
                    ...
                    <div class="card-body py-4">
                        <form action="{{ route('hotelservice.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-6  mb-7">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="file" name="icon" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 @error('icon') is-invalid @enderror" placeholder="Choose Icon" value="{{ old('icon') }}" />
                                        @error('icon')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-md-6  mb-7">
                                    ...
                                    <div class="col-lg-12">
                                        <textarea name="short_description"  id="short_description"
                                            class="form-control form-control-lg   @error('short_description') is-invalid @endif">{{old('short_description')}}</textarea>
                                    </div>
