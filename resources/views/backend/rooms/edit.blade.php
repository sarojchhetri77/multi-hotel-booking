                                ...
                                <div class="col-md-6  mb-7">
                                    ...
                                    <div class="col-lg-12">
                                        <input type="text" name="name"
                                            ...
                                            placeholder="Enter Title" value="{{$room->name}}" />
                                        @error('name')
                                ...
                                <div class="col-md-6  mb-7">
                                    ...
                                    <div class="col-lg-12">
                                        <input type="number" name="capacity"
                                            ...
                                            placeholder="Enter Title" value="{{ $room->capacity }}" />
                                        @error('capacity')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-6  mb-7">
                                    ...
                                    <div class="col-lg-12">
                                        <input type="number" name="no_of_adult"
                                            ...
                                            placeholder="Enter Title" value="{{$room->no_of_adult}}" />
                                        @error('no_of_adult')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-6  mb-7">
                                    ...
                                    <div class="col-lg-12">
                                        <input type="number" name="no_of_children"
                                            ...
                                            placeholder="Enter Title" value="{{$room->no_of_children    }}" />
                                ...
                                <div class="col-md-6  mb-7">
                                    ...
                                    <div class="col-lg-12">
                                        <input type="number" name="room_number"
                                            ...
                                            placeholder="Enter Title" value="{{$room->room_number}}" />
                                        @error('room_number')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-6  mb-7">
                                    ...
                                    <div class="col-lg-12">
                                        <input type="number" name="beds"
                                            ...
                                            placeholder="Enter Title" value="{{$room->beds}}" />
                                        @error('beds')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-6  mb-7">
                                    ...
                                    <div class="col-lg-12">
                                        <input type="text" name="bed_type"
                                            ...
                                            placeholder="Enter Title" value="{{$room->bed_type}}" />
                                        @error('bed_type')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-6  mb-7">
                                    ...
                                    <div class="col-lg-12">
                                        <input type="number" name="price_per_night"
                                            ...
                                            placeholder="Enter Title" value="{{$room->price_per_night}}" />
                                ...
                                <div class="col-md-6  mb-7">
                                    ...
                                    <div class="col-lg-12">
                                        <input type="text" name="room_view"
                                            ...
                                            placeholder="Enter Title" value="{{$room->room_view }}" />
                                        @error('room_view')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-12  mb-7">
                                    ...
                                    <div class="col-lg-12">
                                        <textarea name="description"  id="description"
                                            class="form-control form-control-lg ckeditor-editor  @error('description') is-invalid @endif">{{$room->description}}</textarea>
                                    </div>
                                    @error('description')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
