                            ...
                            <div class="row g-2">
                                <div class="col-md-3">
                                    <div data-target-input="nearest">
                                        <input type="date" name="check_in_date" value="{{session('checkin') }}" class="form-control"
                                            placeholder="Check_in_date"/>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div>
                                        <input type="date" class="form-control" value="{{session('checkout') }}" name="check_out_date"/>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                   <div>
                                    <input type="number" class="form-control" placeholder="No of adult" name="no_of_adult"/>
                                   </div>
                                </div>
                                <div class="col-md-3">
                                    <div>
                                        <input type="number" class="form-control" placeholder="No of Children" name="no_of_children"/>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6">
                    ...
                    <p class="mb-4">
                        {{ $aboutUs && $aboutUs->small_description ? $aboutUs->small_description : 'Tempor erat elitr rebum at clita. Diam dolor diam ipsum sit. Aliqu diam amet diam et eos. Clita erat ipsum et lorem et sit, sed stet lorem sit clita duo justo magna dolore erat amet' }}
                    </p>
                            ...
                            <div class="border rounded p-1">
                                <div class="border rounded text-center p-4">
                                    ...
                                    <h2 class="mb-1" data-toggle="counter-up">
                                        {{ $aboutUs && $aboutUs->num_rooms ? $aboutUs->num_rooms : '1234' }}
                                    </h2>
                        ...
                        <div class="col-sm-4 wow fadeIn" data-wow-delay="0.3s">
                            <div class="border rounded p-1">
                                <div class="border rounded text-center p-4">
                                    ...
                                    <h2 class="mb-1" data-toggle="counter-up">
                                        {{ $aboutUs && $aboutUs->num_staff ? $aboutUs->num_staff : '1234' }}
                                    </h2>
                        ...
                        <div class="col-sm-4 wow fadeIn" data-wow-delay="0.5s">
                            <div class="border rounded p-1">
                                <div class="border rounded text-center p-4">
                                    ...
                                    <h2 class="mb-1" data-toggle="counter-up">
                                        {{ $aboutUs && $aboutUs->num_clients ? $aboutUs->num_clients : '1234' }}
                                    </h2>
                    ...
                    <a class="btn btn-primary py-3 px-5 mt-2" href="{{route('hotelss.aboutus',$hotel->slug)}}">Explore More</a>
                </div>
                @php
                $images = $aboutUs ? json_decode($aboutUs->images, true) : [];
            @endphp
                ...
                <div class="row g-3">
                    <div class="col-6 text-end">
                        <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.1s"
                            src="{{ isset($images[0]) ? asset('storage/' . $images[0]) : asset('frontend/img/about-1.jpg') }}" 
                            style="margin-top: 25%;">
                    </div>
                    <div class="col-6 text-start">
                        <img class="img-fluid rounded w-100 wow zoomIn" data-wow-delay="0.3s"
                            src="{{ isset($images[1]) ? asset('storage/' . $images[1]) : asset('frontend/img/about-2.jpg') }}">
                    </div>
                    <div class="col-6 text-end">
                        <img class="img-fluid rounded w-50 wow zoomIn" data-wow-delay="0.5s"
                            src="{{ isset($images[2]) ? asset('storage/' . $images[2]) : asset('frontend/img/about-3.jpg') }}">
                    </div>
                    <div class="col-6 text-start">
                        <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.7s"
                            src="{{ isset($images[3]) ? asset('storage/' . $images[3]) : asset('frontend/img/about-4.jpg') }}">
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row g-4">
                @forelse ($services as $service)
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <a class="service-item rounded" href="{{route('hotelss.services',$hotel->slug)}}">
                            <div class="service-icon bg-transparent border rounded p-1">
                                <div class="w-100 h-100 border rounded d-flex align-items-center justify-content-center">
                                    {{-- <i class="{{ $service->icon }} fa-2x text-primary"></i> --}}
                                    <img height="50" width="50"  src="{{ asset('storage/' . $service->icon) }}" alt="">
                                </div>
                            </div>
