 ...
 <div class="container-fluid bg-dark px-0">
    <div class="row gx-0">
        <div class="col-lg-3 bg-dark d-none d-lg-block">
            <a href="{{route('hotel.detail',$hotel->slug)}}" class="navbar-brand w-100 h-100 m-0 p-0 d-flex align-items-center justify-content-center">
                <h1 class="m-0 text-light text-uppercase">{{$hotel->name}}</h1>
            </a>
        </div>
        <div class="col-lg-9">
            ...
            <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0">
                <a href="{{route('hotel.detail',$hotel->slug)}}" class="navbar-brand d-block d-lg-none">
                    <h1 class="m-0 text-primary text-uppercase">{{$hotel->name}}</h1>
                </a>
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    ...
                    <div class="nav-item dropdown" style="margin-right: 30px">
                        ...
                        <div class="dropdown-menu rounded-0 me-5">
                            ...
                            <a href="{{route('userselect.room',$hotel->slug)}}" class="dropdown-item">Selected Room</a>
                        </div> --}}
                        @auth
